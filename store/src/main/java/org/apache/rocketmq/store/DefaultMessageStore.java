...
public class DefaultMessageStore implements MessageStore {
     ...
     * 检查存储状态
     *
     * @return 如果是当前 broker 的角色是 slave || 当前状态不可写 || page cache busy -> service not available 或者 os page cache busy
     * 否则 ok
     */
    ...
    public GetMessageResult getMessage(final String group, final String topic, final int queueId, final long offset,
        ...
        // （获得该 topic 对应的 queue ）对应的 ConsumeQueue 对象。
            ...
            if (maxOffset == 0) {
                ...
                if (bufferConsumeQueue != null) {
                    try {
                        ...
                        // 下一个 offset = 当前的 offset + 本次拉取个数的 offset
    ...
    class ReputMessageService extends ServiceThread {
        ...
        private void doReput() {
            ...
            for (boolean doNext = true; this.isCommitLogAvailable() && doNext; ) {
                ...
                // 从 reputationFromOffset 位置处开始同步数据
                // 拿到封装了 ByteBuffer 的数据。
                ...
                if (result != null) {
                    try {
                        ...
                        for (int readSize = 0; readSize < result.getSize() && doNext; ) {
                            // attention 注意，这里不取 message body。也就是只有描述信息，所以 consume queue 比 commit log 小。
