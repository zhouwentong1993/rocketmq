...
public class ConsumerManager {
    ...
    private static final long CHANNEL_EXPIRED_TIMEOUT = 1000 * 120L;
    ...
    public boolean registerConsumer(final String group, final ClientChannelInfo clientChannelInfo,
        ...
        boolean newConsumerIncome =
                consumerGroupInfo.updateChannel(clientChannelInfo, consumeType, messageModel,
                        consumeFromWhere);
        boolean registerTopicChanged = consumerGroupInfo.updateSubscription(subList);

        if ((newConsumerIncome || registerTopicChanged) && isNotifyConsumerIdsChangedEnable) {
            this.consumerIdsChangeListener.handle(ConsumerGroupEvent.CHANGE, group, consumerGroupInfo.getAllChannel());
        }

        this.consumerIdsChangeListener.handle(ConsumerGroupEvent.REGISTER, group, subList);

        return newConsumerIncome || registerTopicChanged;
    }
